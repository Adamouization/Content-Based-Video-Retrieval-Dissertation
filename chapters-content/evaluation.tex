...
First, regarding the histogram models, the HSV histogram model was by far the most performant, followed by the RGB histogram model in some cases and the least performant greyscale histogram model. 
