...
These features can be divided into two categories: static features and dynamic features. This section will first survey examples of static visual descriptors and methods to extract them from videos, and will then focus on examples and methods of extracting dynamic visual descriptors from videos.
...
depends on colour space used (RGB, HSV, ...)

global content VS region-based content. Good matches when comparing low-level visual content can still produce poor results (60\% green and 40\% blue example) \cite{petkovic2000}
...
detect edges, plot distribution of edges in a histogram (EHD)

% ----------------------------------------------------

\subsection{Dynamic Features}

% define features (corners and edges)
