...
\begin{enumerate}
    ...
    \item Chapter 6: Testing \& Evaluation
    \item Chapter 7: Conclusions
    \item Appendix A: Potential Programming Languages Comparison
    \item Appendix B: Text and Binary Files Comparison
    \item Appendix C: Raw Console Output Example
    \item Appendix D: Stored Feature Files
    \item Appendix E: 13 Point Ethics Check List
    \item Appendix F: Experiment Survey
    \item Appendix G: Raw Experiment Results
    \item Appendix H: Code Listings
\end{enumerate}
